...
export const LayersIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M6.115 5.19A5.25 5.25 0 0 1 12 3a5.25 5.25 0 0 1 5.885 2.19m-11.77 0a5.25 5.25 0 0 1 11.77 0m-11.77 0l-1.121 4.793a5.25 5.25 0 0 0 4.286 6.096a5.25 5.25 0 0 0 6.096-4.286L17.885 5.19m-11.77 0a5.25 5.25 0 0 0-4.286 6.096a5.25 5.25 0 0 0 6.096 4.286m0 0a5.25 5.25 0 0 1-5.885 2.19a5.25 5.25 0 0 1 0-11.77a5.25 5.25 0 0 1 5.885 2.19m0 0a5.25 5.25 0 0 0 0 11.77a5.25 5.25 0 0 0 5.885-2.19" />
    </svg>
);
...
export const NewFileIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m.75 12V9.75M8.25 9.75h3.75m-3.75 0H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z" />
  </svg>
);

export const CogIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9.594 3.94c.09-.542.56-.996 1.11-.996h2.593c.55 0 1.02.454 1.11.996l.38 1.951c.28.144.55.303.81.48l1.848-.468c.54-.138 1.08.17 1.32.658l1.3 2.252c.24.487.12.96-.24 1.17l-1.616.98c.03.11.05.22.05.33v2.58c0 .11-.02.22-.05.33l1.616.98c.36.21.48.683.24 1.17l-1.3 2.252c-.24.487-.78.796-1.32.658l-1.848-.468a6.34 6.34 0 01-.81.48l-.38 1.951c-.09.542-.56.996-1.11.996h-2.593c-.55 0-1.02-.454-1.11-.996l-.38-1.951a6.34 6.34 0 01-.81-.48l-1.848.468c-.54.138-1.08-.17-1.32-.658l-1.3-2.252c-.24-.487-.12-.96.24-1.17l1.616-.98c-.03-.11-.05-.22-.05-.33V9.92c0-.11.02.22.05-.33L2.91 8.418c-.36-.21-.48-.683-.24-1.17l1.3-2.252c.24-.487.78-.796 1.32-.658l1.848.468c.26-.177.53-.336.81-.48l.38-1.951zM12 15.75a3.75 3.75 0 100-7.5 3.75 3.75 0 000 7.5z" />
  </svg>
);
...
export const MagnifyPlusIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="m21 21-5.197-5.197m0 0A7.5 7.5 0 1 0 5.196 5.196a7.5 7.5 0 0 0 10.607 10.607ZM10.5 7.5v6m3-3h-6" />
    </svg>
);

export const DownloadSingleIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
